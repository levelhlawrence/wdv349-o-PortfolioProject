...
export default function SignUp() {
  return (
    <section className="flex justify-between">
      <aside className="flex flex-col left-0 right-0 mx-auto w-fit bottom-1/2 top-1/2 justify-center items-center z-50 absolute md:relative shadow-lg md:shadow-none bg-white">
        {/* Form Section */}
        <div className="max-w-1/2 bg-white rounded-lg shadow-md md:shadow-none p-10">
          <h2 className="text-3xl font-bold mb-8">Sign up Form</h2>
          <form className="flex flex-col w-full">
            <label className="text-sm" htmlFor="s-username">
              Username
            </label>
            <Input id="s-username" type="text" />
            <label className="mt-8 text-sm" htmlFor="s-pw-key">
              Password
            </label>
            <Input id="s-pw-key" type="password" />
